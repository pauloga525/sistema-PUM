    ...
    <div className="min-h-screen bg-pum-bg flex flex-col">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/teacher/year"
            className="pum-topbar-btn flex items-center gap-1.5 text-[12px] font-medium text-blue-100/70 hover:text-white px-2.5 py-1.5 rounded-lg"
          >
      ...
      <NotificationModal fetchNotifications={getTeacherNotificationsAction} />
